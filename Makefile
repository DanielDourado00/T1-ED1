...
$(PROJECT_NAME): lista.o main.c parameters.o systempath.o systemgeo.o circ.o
	$(EXEC) $(CFLAGS) lista.o main.c parameters.o systempath.o systemgeo.o circ.o -o $(PROJECT_NAME) -lm
