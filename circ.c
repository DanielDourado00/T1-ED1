...
void* createCircle (int *id, double x, double y, double r, char *corb, char *corp){         // funcao para criar um circulo e setar as informacoes, as informacoes sao passadas por parametro e a funcao retorna um ponteiro para a struct circulo, armazenando as informacoes do circulo na struct
    ...
    settipoCircle(circulo, 'c');                                                            // seta o tipo do circulo
    setidCircle(circulo, id);                                                              // seta o id do circulo
    setxCircle(circulo, x);                                                                // seta a coordenada x do circulo
    setyCircle(circulo, y);                                                                // seta a coordenada y do circulo
    setrCircle(circulo, r);                                                                // seta o raio do circulo
    setcorbCircle(circulo, corb);                                                          // seta a cor da borda do circulo
    setcorpCircle(circulo, corp);                                                          // seta a cor de preenchimento do circulo
